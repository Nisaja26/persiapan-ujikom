...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="card-header text-white" style="background: linear-gradient(90deg, #007bff, #5fa0ff);">
                <h4 class="mb-0">
            ...
            <div class="card-body bg-light">
                ...
                <div class="text-center mb-5">
                    @if(auth()->user()->photo)
                        <img src="{{ asset('storage/' . auth()->user()->photo) }}" alt="Foto Profil"
                            class="rounded-circle shadow mb-3" width="120" height="120" style="object-fit: cover;">
                    @else
                        <img src="{{ asset('sb-admin2/img/admin.png') }}" alt="Default Avatar"
                            class="rounded-circle shadow mb-3" width="120" height="120" style="object-fit: cover;">
                    @endif
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" class="bg-white p-4 rounded-4 shadow-sm">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control border-0 bg-light shadow-sm" name="name"
                ...
                <div class="mb-5">
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="bg-white p-4 rounded-4 shadow-sm">
                        @csrf
                        @method('PUT')
